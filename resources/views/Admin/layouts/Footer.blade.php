...
<footer class="sticky-footer bg-white">
    <div class="container my-auto">
        <div class="text-center">
            <span>&copy; Garage V.Parrot 2023</span>
        </div>
    </div>
</footer>
<!-- End of Footer -->
...
<!-- datatable -->
<script src="{{asset('DashboardTemplate/vendor/datatables/jquery.dataTables.min.js')}}"></script>
<script src="{{asset('DashboardTemplate/vendor/datatables/dataTables.bootstrap4.min.js')}}"></script>
